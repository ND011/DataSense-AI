            ...
            <div className="mt-4 flex flex-wrap gap-x-4 gap-y-2">
                {labels.map((label, i) => (
                    <div key={i} className="flex items-center gap-2">
                        ...
                        <span className="text-[10px] text-white/70 font-medium truncate max-w-[120px]" title={label}>{label}</span>
                    </div>
                ))}
            </div>
        </div>
...
export default function ResultsDashboard({ data, onBack }) {
    ...
    const hasTimeSeries = allCharts.some(chart => ['line', 'area'].includes(chart.chart_type));
            ...
            >
                <div className="flex items-center gap-8 flex-1">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="font-bold text-xl tracking-tight text-white line-clamp-1">Analytix</span>
                    </div>
            ...
            <div className="space-y-8 animate-in fade-in duration-500">
                <div className="flex flex-col lg:flex-row gap-6 items-center justify-between glass p-6 mb-10 relative overflow-hidden group">
                    ...
                    <div className="relative w-full lg:w-[450px] z-10">
                        ...
                        <input
                            type="text"
                            placeholder="Search specific visualizations..."
                            value={searchQuery}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 pb-12">
                    {allCharts
                        ...
                        .map((chart, idx) => (
                            <div key={idx} className={`glass p-5 pb-2 flex flex-col min-h-[420px] group hover:-translate-y-1 transition-all duration-500 overflow-hidden relative ${chart.chart_type === 'geo_map' ? 'lg:col-span-3' : ''}`}>
